  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      <View style={styles.header}>
        <Text style={{ fontSize: 25, position: 'absolute', paddingTop: 5, color: '#088F8F', fontWeight: 'bold' }}> News Feed</Text>
      ...
      <ScrollView style={styles.content}>
        <View style={{ height: 450, marginBottom: 10, marginTop: 0 }}>
          ...
          <View style={{ height: 100 }}>
            <View style={{ justifyContent: 'space-between', flexDirection: 'row' }}>
              ...
              <View style={{ height: '20%', width: '15%', margin: '2%', alignItems: 'flex-end', flexDirection: 'row', marginVertical: 18, marginRight: 50 }}>
            ...
            <View style={{ paddingLeft: '3%' }}>
              <Text style={{ fontFamily: "SF-UI-Text-Bold", fontSize: 12, paddingBottom: '0.5%', marginTop: -20 }}>Each template offers guidance on key sections to include, as well as tips for selling the</Text>
            </View>
        ...
        <View style={{ height: 450, marginBottom: 10, marginTop: -120 }}>
          ...
          <View style={{ height: 100 }}>
            ...
            <View style={{ paddingLeft: '3%' }}>
              <Text style={{ fontFamily: "SF-UI-Text-Bold", fontSize: 12, paddingBottom: '0.5%', marginTop: -20 }}>Each template offers guidance on key sections to include, as well as tips for selling the position and being clear</Text>
            </View>
